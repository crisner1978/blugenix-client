...
export default function HomePage() {
  ...
  return (
    <div className="overflow-hidden">
      ...
      <Section
        style_section="pt-48 pb-36 md:flex-row items-center md:flex flex flex-col-reverse mx-auto max-w-7xl md:gap-5"
        heading="How we help"
      ...
      >
        <div className="overflow-hidden rounded-3xl">
          <img
          className="rounded-3xl scale-[1.009]"
          src="https://res.cloudinary.com/dtram9qiy/image/upload/v1651073011/my-upload/vyh4v0uwmwuhpgvtmi0q.jpg"
          alt=""
        />
        </div>
      </Section>
      <div className="max-w-7xl mx-auto mt-10 pb-48">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 px-5">
          <div className="group cursor-pointer overflow-hidden rounded-3xl shadow-xl"><img className="steps" src="https://res.cloudinary.com/dtram9qiy/image/upload/v1651075090/my-upload/a9wksql2kb2pzvnqpxda.jpg" alt="" /></div>
          <div className="group cursor-pointer overflow-hidden rounded-3xl shadow-xl"><img className="steps" src="https://res.cloudinary.com/dtram9qiy/image/upload/v1651075125/my-upload/au38suzmsu1mzgrczvm6.jpg" alt="" /></div>
          <div className="group cursor-pointer overflow-hidden rounded-3xl shadow-xl"><img className="steps" src="https://res.cloudinary.com/dtram9qiy/image/upload/v1651075148/my-upload/gonhzeluwpd0okuuyrnb.jpg" alt="" /></div>
        </div>
